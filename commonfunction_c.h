...
class WinFunctions {
public:
    static string utf_to_gbk_string(const char* in, int length) {
        char* gbk_char = new char[length];
        if (0 > utf8_to_gbk(in, length, gbk_char, length))
            throw "Error : utf8 to gbk failed ,in common functions";
        string result(gbk_char);
        delete[] gbk_char;
        gbk_char = NULL;
        return result;
    }
...
作者        : xxx
*********************************************************************/
    static int unicode_to_multibyte(const char* unicodeStr, int unicodeStrLen, char* multiByteStr, int multiByteStrLen, UINT multiByteCharsetFlag)
    {
    ...
    作者        : xxx
    *********************************************************************/
    static int multibyte_to_unicode(const char* multiByteStr, int multiByteStrLen, UINT multiByteCharsetFlag, char* unicodeStr, int unicodeStrLen)
    {
    ...
    作者        : xxx
    *********************************************************************/
    static int utf8_to_gbk(const char* utf8str, int utf8strlen, char* gbkstr, int gbkstrlen)
    {
        ...
        int unicodebytes = multibyte_to_unicode(utf8str, utf8strlen, CP_UTF8, unicodestr, 2 * utf8strlen);//utf8转unicode
        ...
        int gbkbytes = unicode_to_multibyte(unicodestr, unicodebytes, gbkstr, gbkstrlen, CP_ACP);//unicode转GBK
